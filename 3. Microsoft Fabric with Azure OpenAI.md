...
2. 화면 왼쪽 아래 `Microsoft Fabric` -> `Data Engineering`로 이동 <br/> 
   ![image](https://github.com/user-attachments/assets/9bd9c86e-3370-4994-b3de-4cc052f43976)

3. 작업 영역(Workspaces) 만들기: `+ New workspace` -> 이름 입력 (ex. WS-FABRAG) -> `Apply` <br/> 
   ![image](https://github.com/user-attachments/assets/8165904d-5233-491f-9547-68b6977f2661)

   작업 영역의 URL 링크 중 /groups/.../list 사이 값이 해당 **작업 영역 ID** 입니다.([Workspace ID 자세히](https://learn.microsoft.com/en-us/fabric/admin/portal-workspace#identify-your-workspace-id)) <br/> 
...
**Fabric 자원 및 아티팩트 배치**
 ...
 2.   화면 오른쪽 상단의 Azure Cloud Shell을 클릭합니다. ![image](https://github.com/user-attachments/assets/4cf4913b-d49d-44c2-b6c6-bf762929dc47)
