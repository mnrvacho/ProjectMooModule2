...
1. [Walmart Dataset](https://1drv.ms/x/c/e81b0d38d842b18c/ERkoJgWoNblEnqaGECljMwQBYewvXeiKbfQfltSqq35-ug?e=l0c8w1) 월마트 데이터세트 다운로드 후 압축을 풀고, Azure Blob Storage의 컨테이너 **playground** 에 업로드합니다. 
