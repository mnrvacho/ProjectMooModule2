...
- .sql 스크립트는 Azure Data Studio 또는 SQL Server Management Studio(SSMS)와 같은 툴을 이용해서 실행할 수 있습니다. 별도의 툴 설치를 원치 않을 경우, Azure Portal에서 생성한 리소스 Azure SQL Database의 메뉴 **'Query Editor'** 기능에서 실행할 수 있습니다.
  
- Azure SQL DB 생성 시 입력한 **SQL server authentication 정보 또는 Microsoft Entra** 를 이용하여 쿼리편집기에 연결합니다. 
...
<br/> 
- `02-load-table.sql` 를 사용하여 CSV 파일을 `walmart_ecommerce_product_details` 테이블에 로드합니다. https://github.com/mnrvacho/ProjectMooModule2/blob/main/2.%20sqldb%20scripts/02-load-table.sql  
<br/>
